...
def main():
    ...
    p.add_argument("--email", help="git user.email to set for this repo (optional)")
    p.add_argument("--push", action="store_true", help="push to remote after creating commits (requires remote configured)")
